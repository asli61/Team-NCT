...
Route::get("fire-report", "FireInputController@index");//the data is collected by url GET parameters
...
Route::view('/yanginlar', 'fires-display-view')->name("fires-display-view");
